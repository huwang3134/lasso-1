...
library("ggrepel")
library("pander")
source("/Users/stanza/desktop/lasso_r/fun.R")
```

```{r, include=T, echo=F, warning=F, 	message = FALSE}
# read data
bpraw <- read.csv("/Users/stanza/desktop/lasso_r/bpraw.csv") 
bptrans <- read.csv("/Users/stanza/desktop/lasso_r/bptrans.csv", na.strings = NaN)
tcode <- read.csv("/Users/stanza/desktop/lasso_r/tcode.csv", stringsAsFactors = F) 
short <- read.csv("/Users/stanza/desktop/lasso_r/short.csv", stringsAsFactors = F) %>% unname()
long <- read.csv("/Users/stanza/desktop/lasso_r/long.csv", stringsAsFactors = F) %>% unname()
